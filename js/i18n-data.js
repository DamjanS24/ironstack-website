...
window.I18N = {
  en: {
    ...
    "services.sub": "Four steps on one ladder. Each one stands on its own, and each one makes the next easier. The destination is always the same: infrastructure you own, run with care.",
    ...
    "services.s4b": "For companies with an existing environment to move. A complete transfer from rented cloud or legacy hosting to infrastructure you own, executed in the five phases above at a fixed project fee. This is how clients with history come on board.",
    ...
    "faq.a3": "The audit has a small fixed price. The Stack has a fixed setup fee. Managed Sovereignty has a fixed monthly price per tier. Migrations have a fixed project fee based on the audit findings. You always know the number before anything starts, and the number does not move.",
  ...
  nl: {
    ...
    "services.sub": "Vier treden op één ladder. Elke trede staat op zichzelf, en elke trede maakt de volgende makkelijker. De bestemming is altijd dezelfde: infrastructuur die van jou is, met zorg gedraaid.",
    ...
    "services.s4b": "Voor bedrijven met een bestaande omgeving die moet verhuizen. Een complete overstap van gehuurde cloud of legacy hosting naar infrastructuur in eigendom, uitgevoerd in de vijf fasen hierboven tegen een vaste projectprijs. Zo komen klanten met geschiedenis aan boord.",
    ...
    "faq.q3": "Wat kost het?",
    "faq.a3": "De audit heeft een kleine vaste prijs. De Stack heeft een vaste installatieprijs. Beheerde Soevereiniteit heeft een vast maandbedrag per niveau. Migraties hebben een vaste projectprijs op basis van de auditbevindingen. Je kent het bedrag altijd voordat er iets begint, en dat bedrag beweegt niet.",
