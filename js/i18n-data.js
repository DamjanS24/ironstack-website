...
window.I18N = {
  en: {
    ...
    "services.s1b": "The entry for clarity. Where does your data live, what does everything cost, what could you reclaim, and where do GDPR and AI expose you? A fixed price investigation with a written report that stays useful whatever you decide next.",
    "services.s2t": "AI & Automation",
    "services.s2b": "The entry for quick wins. Voice assistants that answer and book, chat assistants that know your business, and automations that clear the busywork away, built on the systems you already have. Fixed scope, fixed price per project.",
    "services.s3t": "The Ironstack Stack",
    "services.s3b": "The build for a fresh start. Your business systems installed on a server you own, wired together and configured for how you work, with little or nothing to migrate. The core is the same stack that runs Ironstack itself: one fixed setup fee, then a fixed monthly price.",
    "services.s4t": "Migration",
    "services.s4b": "The build for an existing environment. A complete transfer from rented cloud or legacy hosting to infrastructure you own, executed in the five phases below at a fixed project fee.",
    "services.s5t": "Managed Sovereignty",
    "services.s5b": "Every path above ends here. I stay responsible for what we built: updates, backups, monitoring and response, included hours, and a monthly health report in plain language. A fixed monthly price per tier, and the exit clause applies every single month. This is the heart of Ironstack; the rest is how you arrive.",
  ...
  nl: {
    ...
    "services.s1b": "De ingang voor duidelijkheid. Waar staat je data, wat kost alles, wat kun je terugwinnen, en waar stellen AVG en AI je bloot? Een onderzoek met vaste prijs en een schriftelijk rapport dat waardevol blijft, wat je hierna ook beslist.",
    "services.s2t": "AI & Automatisering",
    "services.s2b": "De ingang voor snelle winst. Spraakassistenten die opnemen en inplannen, chatassistenten die je bedrijf kennen, en automatiseringen die het routinewerk wegwerken, gebouwd op de systemen die je al hebt. Vaste scope, vaste prijs per project.",
    "services.s3t": "De Ironstack Stack",
    "services.s3b": "De bouw voor een frisse start. Jouw bedrijfssystemen, geïnstalleerd op een server die van jou is, gekoppeld en ingericht op hoe jij werkt, met weinig of niets te verhuizen. De kern is dezelfde stack waar Ironstack zelf op draait: één vaste installatieprijs, daarna een vast maandbedrag.",
    "services.s4t": "Migratie",
    "services.s4b": "De bouw voor een bestaande omgeving. Een complete overstap van gehuurde cloud of legacy hosting naar infrastructuur in eigendom, uitgevoerd in de vijf fasen hieronder tegen een vaste projectprijs.",
    "services.s5t": "Beheerde Soevereiniteit",
    "services.s5b": "Elk pad hierboven eindigt hier. Ik blijf verantwoordelijk voor wat we bouwden: updates, back-ups, monitoring en respons, inbegrepen uren en een maandelijkse gezondheidsrapportage in gewone taal. Een vast maandbedrag per niveau, en de exit-clausule geldt elke maand opnieuw. Dit is het hart van Ironstack; de rest is hoe je er komt.",
